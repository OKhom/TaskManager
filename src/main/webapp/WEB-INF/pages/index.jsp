...
<html>
    ...
    <body>
        <div class="container">
           <h3><img height="50" width="55" src="<c:url value="/static/logo.png"/>"/><a href="/">Tasks List</a></h3>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            <li><button type="button" id="add_task" class="btn btn-default navbar-btn">Add Task</button></li>
                            <li><button type="button" id="add_group" class="btn btn-default navbar-btn">Add Group</button></li>
                            <li><button type="button" id="delete_task" class="btn btn-default navbar-btn">Delete Task</button></li>
            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${tasks}" var="task">
                    <tr>
                        <td><input type="checkbox" name="ids[]" value="${task.id}" id="checkbox_${task.id}"/></td>
                        <td>${task.taskName}</td>
                        <td>${task.taskDate}</td>
                        <td>${task.phone}</td>
                        <td>${task.email}</td>
                        <c:choose>
                            <c:when test="${task.group ne null}">
        ...
        <script>
            ...
            $('#add_task').click(function(){
                window.location.href='/task_add_page';
            });
            ...
            $('#delete_task').click(function(){
                ...
                $.post("/task/delete", data, function(data, status) {
